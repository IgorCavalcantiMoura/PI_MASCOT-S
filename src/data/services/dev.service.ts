...
export class DevService implements TypeOrmOptionsFactory {
    ...
    createTypeOrmOptions(): TypeOrmModuleOptions {
        return {
            ...
            entities: [User, Administrador, Auxiliar, ProdutoEstoque, DonoPet, Pet, Veterinario, Consulta, Exame, Internacao, BoletimMedico, Medicamento, AdminMedicamentos, Procedimento],
            synchronize: true,
    };
  }
}