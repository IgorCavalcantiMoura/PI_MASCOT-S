...
export class Exame {
    ...
    @ApiProperty({ description: 'Status do exame', example: 'Pendente, Em análise e Finalizado' })
    @Column({
      type: 'enum',
      enum: ['Pendente', 'Em análise', 'Finalizado'],
      default: 'Pendente',
    })
    status: string
